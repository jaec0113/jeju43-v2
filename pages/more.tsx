...
export default function More() {
  return (
    <Layout
      title='Jeju 4.3 Incident Learn More | Jeju 4.3 Incident Website'
      keywords='Jeju 4.3, Jeju 4.3 Incident, Jeju 4.3 Massacre, Jeju 4.3 Uprising, Jeju history, April 3 Incident, Jeju April 3 Incident, Jeju 4.3 more'
        ...
        <div className={styles.pageInfo}>
          ...
          <div className={styles.pageSection}>
            ...
            <p>
              ...
              there. Broadly speaking I would say that most are broadly aware
              that it happened and that many people were killed by the South
              Korean government. Why it happened and whether the police and
              military{`'`}s actions were justified is where there is a lot more
          ...
          <div className={styles.pageSection}>
            ...
            <p>
              ...
              politically) who will claim that the resistance group was part of
              a broader communist plot to disrupt and overthrow the newly
              established South Korean government and to help united the country
              under Kim Ilsung
              {`'`}s communist North Korea. You will also find people (often
            ...
            <p>
              ...
              had that were completely unrelated to communism that were larger
              drivers of the decision to begin an armed resistance. There is no
              real evidence to support the idea that North Korea supported the
              resistance other then in idea nor is there any real supporting
              evidence to suggest that the national South Korea Labor Party
              (which was communist in nature) supported the resistance either -
              again except in idea.
            </p>
            <p>
              ...
              the best equipment they had were old bolt action rifles the
              Japanese left after World War II. Many were equipped with simple
              spears that were made out of bamboo. To kill 20-30,000 in order to
              catch 400 or so is virtually unjustifiable.
            </p>
          </div>
          <div className={styles.pageSection}>
            ...
            <p>
              ...
              Incident? Should the US pay reparations to the Jeju people who
              those who died?
            </p>
            <p>
            ...
            <p>
              ...
              have been in charge, all of those orders came from the South
              Korean police and military. Additionally there is no direct
              evidence that USAMGIK ordered any of the suppression methods.
              However, many will counterargue that it is not possible for
              USAMGIK to be unaware of what the police and army were doing, and
              if USAMGIK had wished to stop it they could have easily. Therefore
              proving direct US involvement is unnecessary as they are already
              tacitly guilty of what happened.
            </p>
            <p>
              I think, if anyone is waiting for an official US apology and
              recognition of their actions, I feel I can confidently say that
              day will likely never come as the US does not easily recognize the
              country
          ...
          <div className={styles.pageSection}>
            ...
            <p>
              ...
              I think that{`'`}s probably a case-by-case type thing to a certain
              extent. I don{`'`}t think people who talk about or teach about 4.3
              should ever be {`'`}afraid{`'`} of talking about anything that may
              fall in those different levels, but I don{`'`}t think everyone
              needs to know everything. Younger children may not need to know
              (yet) things pertaining to my level 2 and 3. Not all adults need
              to know all of it either. Some people may not be ready to hear
              everything. Some people may not want to hear everything. Learning
              about and teaching about 4.3 is something that I think is a long
